...
The skill installs to `/sandbox/.hermes/skills/aiq-research`. Replace `$SKILL_DIR` with
that path in all commands, or set `SKILL_DIR=/sandbox/.hermes/skills/aiq-research` in
your `.hermes/.env`.
