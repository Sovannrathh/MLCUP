...
The [`docs/local-docs/`](docs/local-docs/) folder contains plain Markdown guides for local development and integration setup — no build step required.

| Guide | Description |
|-------|-------------|
| [Hermes setup](docs/local-docs/hermes/quickstart-hermes.md) | Install NemoClaw, onboard Hermes, connect dashboard and API |
| [Matrix integration](docs/local-docs/matrix/local-synapse.md) | Connect Hermes to a local Matrix homeserver on WSL2 |
| [Command reference](docs/local-docs/command-reference.md) | OpenShell, NemoClaw/NemoHermes, and Hermes CLI quick-reference |
